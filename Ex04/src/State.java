...
public class State {
	...
	public int get_g_value() { return this.g_value; }
	public int get_h_value() { return this.h_value; }
	public int get_f_value() { return this.f_value; }
	...
	public void set_g_value(int g) { this.g_value = g; }
	public void set_h_value(int h) { this.h_value = h; }
	public void set_f_value(int f) { this.f_value = f; }
	...
	public State(int[][] cb, Point spc_loc, State parent, String prev) {
		...
		this.set_g_value(this.get_move_path().size() - 1);
	}
